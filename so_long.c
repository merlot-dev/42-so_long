...
/*   Updated: 2024/02/27 15:12:38 by josegar2         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(int argc, char **argv)
{
	...
	im.img = mlx_xpm_file_to_image(x.mlx, "sprites/pacman-dw.xpm", &im.w, &im.h);
	mlx_put_image_to_window(x.mlx, x.win, im.img, 0, 0);
	im.img = mlx_xpm_file_to_image(x.mlx, "sprites/pacman20-dw.xpm", &im.w, &im.h);
	mlx_put_image_to_window(x.mlx, x.win, im.img, 0, 40);
	im.img = mlx_xpm_file_to_image(x.mlx, "sprites/ghost20-red-dw.xpm", &im.w, &im.h);
	mlx_put_image_to_window(x.mlx, x.win, im.img, 0, 60);
	im.img = mlx_xpm_file_to_image(x.mlx, "sprites/ghost-red-dw.xpm", &im.w, &im.h);
	mlx_put_image_to_window(x.mlx, x.win, im.img, 0, 80);
	mlx_hook(x.win, 2, 0, hook_handler, &x);
	mlx_hook(x.win, 17, 0, exit_game, &x);
	mlx_loop(x.mlx);
}
