...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/01/05 15:21:44 by josegar2          #+#    #+#             */
/*   Updated: 2024/02/22 16:50:44 by josegar2         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		ft_prfstr(va_list args, t_flags tf);
int		ft_prfptr(va_list args, t_flags tf);
int		ft_prfnbr(va_list args, t_flags fl, int isuint);
int		ft_prfhexa(va_list args, t_flags tf, int upper, int isptr);
int		is_flag(const char *c);
void	ft_flags_init(t_flags *tf);
void	ft_flags_set(const char *c, t_flags *tf);
int		ft_write(const char **c);
int		ft_printf(const char *format, ...);
char	*ft_split_1nl(char **s1);
void	*ft_free(void *p);
